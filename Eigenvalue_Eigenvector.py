...
grid_x, grid_y = np.mgrid[grid_min:Ly:17j, grid_min:Ly:17j]
...
#cbar.set_ticks([z_max, (z_min + z_max)/7, 2*(z_min + z_max)/7, 3*(z_min + z_max)/7, 4*(z_min + z_max)/7, 5*(z_min + z_max)/7, 6*(z_min + z_max)/7 ,z_min])
